    ...
    <h3 className='center'>Tic-Tac-Toe</h3>    
      <div className='xZero'>
       ...
       <div style={{display: this.state.results}}>
        ...
        <button className='button' onClick={this.refrech}  >НАЧАТЬ ЗАНОВО</button>
        <button className='button' onClick={this.revClickX}> First - X</button>
        <button className='button' onClick={this.revClickO}> First - 0</button>
    </div>
  );
}
}
